...
export const metadata: Metadata = {
  title: "AutoPrime - Premium Car Dealership | New & Used Cars",
  description: "Find your perfect car at AutoPrime. Premium new and used vehicles with competitive financing, expert service, and 25+ years of trusted experience.",
  keywords: "car dealership, new cars, used cars, auto financing, car loans, luxury cars, electric vehicles, Mercedes, BMW, Audi, Toyota, Honda",
  ...
  openGraph: {
    ...
    description: "Discover premium vehicles with unbeatable prices and flexible financing options. Your dream car awaits at AutoPrime.",
    siteName: "AutoPrime",
    images: [
      {
        url: "https://images.pexels.com/photos/18108314/pexels-photo-18108314.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "AutoPrime car dealership showroom"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "AutoPrime - Premium Car Dealership",
    description: "Find your perfect car with competitive financing and expert service.",
